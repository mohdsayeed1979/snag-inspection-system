...
('v0000000-0000-0000-0000-000000000023', 'b0000000-0000-0000-0000-000000000003', 'Rashed Al-Marri', 'Saudi Construction Co.', 'Khatib & Alami', 'Eng. Khalid', 0),
('v0000000-0000-0000-0000-000000000024', 'b0000000-0000-0000-0000-000000000003', 'Mona Al-Suwaidi', 'Saudi Construction Co.', 'Khatib & Alami', 'Eng. Khalid', 0),
('v0000000-0000-0000-0000-000000000025', 'b0000000-0000-0000-0000-000000000003', 'Saleh Al-Harthi', 'Saudi Construction Co.', 'Khatib & Alami', 'Eng. Khalid', 0),
('v0000000-0000-0000-0000-000000000026', 'b0000000-0000-0000-0000-000000000003', 'Jawaher Al-Mansoori', 'Saudi Construction Co.', 'Khatib & Alami', 'Eng. Khalid', 0),
('v0000000-0000-0000-0000-000000000027', 'b0000000-0000-0000-0000-000000000003', 'Sultan Al-Otaibi', 'Saudi Construction Co.', 'Khatib & Alami', 'Eng. Khalid', 0),
('v0000000-0000-0000-0000-000000000028', 'b0000000-0000-0000-0000-000000000003', 'Deema Al-Sabhan', 'Saudi Construction Co.', 'Khatib & Alami', 'Eng. Khalid', 0),
('v0000000-0000-0000-0000-000000000029', 'b0000000-0000-0000-0000-000000000003', 'Waleed Al-Bawardi', 'Saudi Construction Co.', 'Khatib & Alami', 'Eng. Khalid', 0),
('v0000000-0000-0000-0000-000000000030', 'b0000000-0000-0000-0000-000000000003', 'Ghada Al-Jasser', 'Saudi Construction Co.', 'Khatib & Alami', 'Eng. Khalid', 0)
...
-- Kitchen items
('i0000000-0000-0000-0000-000000000001', 'SNAG-2026-0001', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000001', 'Ground Floor', 'Kitchen', 'Cleanliness', 'General cleaning and removal of silicon and glue residue.', 'low', 'closed', NULL, '2026-07-25', NULL, NULL, 'No comments'),
('i0000000-0000-0000-0000-000000000002', 'SNAG-2026-0002', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000001', 'Ground Floor', 'Kitchen', 'Scratches and Touch-ups', 'Minor scratches and touchups needed on cabinet doors.', 'medium', 'closed', NULL, '2026-07-25', NULL, NULL, 'Resolved'),
('i0000000-0000-0000-0000-000000000003', 'SNAG-2026-0003', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000001', 'Ground Floor', 'Kitchen', 'Drawer Alignment', 'Align drawers and ensure smooth soft-close functionality.', 'medium', 'closed', NULL, '2026-07-25', NULL, NULL, 'Fixed'),
('i0000000-0000-0000-0000-000000000004', 'SNAG-2026-0004', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000001', 'Ground Floor', 'Kitchen', 'Hinges Check', 'Check door hinges safety and grease/tighten as required.', 'low', 'in_progress', NULL, '2026-07-25', NULL, NULL, 'Hinges squeaking'),
('i0000000-0000-0000-0000-000000000005', 'SNAG-2026-0005', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000001', 'Ground Floor', 'Kitchen', 'Missing Accessories', 'Cabinet handles missing on two top drawers.', 'high', 'open', NULL, '2026-07-25', NULL, NULL, 'Cabinet handles missing'),
('i0000000-0000-0000-0000-000000000006', 'SNAG-2026-0006', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000001', 'Ground Floor', 'Kitchen', 'Panel Deflection', 'Minor bending in wooden shelving under the sink.', 'medium', 'closed', NULL, '2026-07-25', NULL, NULL, 'No action needed'),
-- Wardrobe items
('i0000000-0000-0000-0000-000000000007', 'SNAG-2026-0007', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000002', 'First Floor', 'Bedroom 1', 'Frame Fixing', 'Structure and vertical frame fixing check with wall and floor.', 'high', 'closed', NULL, '2026-07-28', NULL, NULL, 'Sturdy'),
('i0000000-0000-0000-0000-000000000008', 'SNAG-2026-0008', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000002', 'First Floor', 'Bedroom 1', 'Sliding Doors', 'Sliding doors not closing fully or dragging.', 'medium', 'closed', NULL, '2026-07-28', NULL, NULL, 'Good'),
('i0000000-0000-0000-0000-000000000009', 'SNAG-2026-0009', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000002', 'First Floor', 'Bedroom 1', 'Bottom Sagging', 'Sagging or gap in the bottom wardrobe plinth.', 'low', 'closed', NULL, '2026-07-28', NULL, NULL, 'Resolved'),
('i0000000-0000-0000-0000-000000000010', 'SNAG-2026-0010', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000002', 'First Floor', 'Bedroom 1', 'Doors Alignment', 'Align wardrobe doors to close evenly without gaps.', 'medium', 'closed', NULL, '2026-07-28', NULL, NULL, 'Aligned'),
('i0000000-0000-0000-0000-000000000011', 'SNAG-2026-0011', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000002', 'First Floor', 'Bedroom 1', 'Drawers Straightness', 'Check drawers guide rails and make sure they open straight.', 'low', 'closed', NULL, '2026-07-28', NULL, NULL, 'All straight'),
('i0000000-0000-0000-0000-000000000012', 'SNAG-2026-0012', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000002', 'First Floor', 'Bedroom 1', 'Scratches & Trims', 'Scratches on the edge banding and side panel wood grain.', 'low', 'closed', NULL, '2026-07-28', NULL, NULL, 'Done'),
('i0000000-0000-0000-0000-000000000013', 'SNAG-2026-0013', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000002', 'First Floor', 'Bedroom 1', 'Internal Accessories', 'Check hanging rod brackets and shelf pins.', 'low', 'closed', NULL, '2026-07-28', NULL, NULL, 'OK'),
('i0000000-0000-0000-0000-000000000014', 'SNAG-2026-0014', 'v0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000002', 'First Floor', 'Bedroom 1', 'Lighting Sensor', 'LED strip sensor fails to turn on when opening left wardrobe door.', 'medium', 'rectified', NULL, '2026-07-28', NULL, NULL, 'Awaiting QA signoff')
