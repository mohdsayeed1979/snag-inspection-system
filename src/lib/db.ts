...
export const dbService = {
  ...
  generateProjectChecklists: (projectId: string, templateIds?: string[]): { itemsCreated: number; villaCount: number; unitCount: number; roomCount: number; templateCount: number } => {
    ...
    const DEFAULT_ROOM_CHECKPOINTS: Record<string, { category: string; item: string }[]> = {
      entrance: [
        { category: 'Doors', item: 'Main Door Leaf Alignment & Plumb' },
        { category: 'Doors', item: 'Door Frame Fixation & Architrave Joints' },
        { category: 'Doors', item: 'Door Lock Mechanism & Cylinder Smoothness' },
        { category: 'Doors', item: 'Door Hinges & Soft Closers Test' },
        { category: 'Doors', item: 'Door Stopper & Rubber Weather Gasket' },
        { category: 'Architectural', item: 'Threshold Level & Perimeter Sealant' },
        { category: 'Paint', item: 'Wall Paint Finish & Touchup' },
        { category: 'Paint', item: 'Ceiling Paint Uniformity' },
        { category: 'Lighting', item: 'Entrance Ceiling Light Fixture' },
        { category: 'Electrical', item: 'Intercom Panel & Doorbell Button Test' },
        { category: 'Flooring', item: 'Floor Tile Leveling, Alignment & Grouting' },
        { category: 'Architectural', item: 'Silicone Perimeter Sealant' },
        { category: 'Cleaning', item: 'Entrance Area Dust Free & Final Cleaning' }
      ],
      hall: [
        { category: 'Paint', item: 'Wall Paint Finish & Color Uniformity' },
        { category: 'Paint', item: 'Ceiling Paint Smoothness & Level' },
        { category: 'Paint', item: 'Paint Color Uniformity & Shade Match' },
        { category: 'Paint', item: 'Wall Paint Touch-Up & Patch Check' },
        { category: 'Paint', item: 'Plaster & Wall Surface Cracks Check' },
        { category: 'Electrical', item: 'Switches Functionality & Plate Mounting' },
        { category: 'Electrical', item: 'Socket Outlets Grounding & Power Test' },
        { category: 'Electrical', item: 'TV Coaxial Outlet Connection' },
        { category: 'Electrical', item: 'Data / RJ45 Internet Outlet Test' },
        { category: 'Lighting', item: 'Ceiling Lights Mounting & Operation' },
        { category: 'Lighting', item: 'Spot Lights & Dimmer Control Test' },
        { category: 'Flooring', item: 'Floor Tile Alignment & Joint Straightness' },
        { category: 'Flooring', item: 'Hollow Tile Test (Tap Test)' },
        { category: 'Flooring', item: 'Tile Grouting Integrity & Sealing' },
        { category: 'Flooring', item: 'Skirting Tiles Fixation & Alignment' },
        { category: 'Windows', item: 'Window Lock & Latch Mechanism' },
        { category: 'Windows', item: 'Window Handle & Roller Tracks Smoothness' },
        { category: 'Windows', item: 'Window Glass Condition & Scratch Test' },
        { category: 'Windows', item: 'Perimeter Weather Silicone Seal' },
        { category: 'Doors', item: 'Door Leaf Alignment & Clearance' },
        { category: 'Doors', item: 'Hinges Fixation & Hardware Finish' },
        { category: 'Doors', item: 'Door Lock & Latch Operation' },
        { category: 'Doors', item: 'Door Stopper Installation' }
      ],
      kitchen: [
        { category: 'Joinery', item: 'Cabinet Cleanliness & Dust Free Inside' },
        { category: 'Joinery', item: 'Cabinet Doors & Drawers Scratch Test' },
        { category: 'Joinery', item: 'Cabinet Box Alignment & Plumb' },
        { category: 'Joinery', item: 'Drawer Soft-Close Slide Alignment' },
        { category: 'Joinery', item: 'Cabinet Door Hinges & Soft Closers Test' },
        { category: 'Joinery', item: 'Missing Accessories & Handles Check' },
        { category: 'Joinery', item: 'Cabinet Panel Warping & Veneer Inspection' },
        { category: 'Joinery', item: 'Countertop Polish & Edge Chamfer Finish' },
        { category: 'Joinery', item: 'Countertop Backsplash Joint Sealing' },
        { category: 'Plumbing', item: 'Kitchen Sink Under-Counter Mounting & Seal' },
        { category: 'Plumbing', item: 'Sink Water Mixer Tap Operation & Flow' },
        { category: 'Plumbing', item: 'Sink Water Drain Trap & Leakage Test' },
        { category: 'Plumbing', item: 'Dishwasher Water Supply & Drain Point' },
        { category: 'Finishes', item: 'Wall Tiles Alignment & Joint Grouting' },
        { category: 'Finishes', item: 'Countertop & Splash Anti-Fungal Silicone Sealant' },
        { category: 'Finishes', item: 'Kitchen Ceiling & Under-Cabinet Lighting' },
        { category: 'Finishes', item: 'Exhaust Fan / Range Hood Duct Connection' },
        { category: 'Finishes', item: 'Floor Tile Drainage Slope & Final Cleaning' }
      ],
      bathroom: [
        { category: 'Sanitary Ware', item: 'Wash Basin Fixation & Seal' },
        { category: 'Sanitary Ware', item: 'Vanity Cabinet Alignment & Drawers' },
        { category: 'Sanitary Ware', item: 'Bathroom Mirror Mounting & Anti-Fog Light' },
        { category: 'Sanitary Ware', item: 'WC / Toilet Bowl Fixation & Floor Seal' },
        { category: 'Sanitary Ware', item: 'Toilet Flush Mechanism & Tank Fill Level' },
        { category: 'Sanitary Ware', item: 'Bidet Spray & Angle Valve Pressure Test' },
        { category: 'Shower', item: 'Shower Mixer Operation & Water Temp Control' },
        { category: 'Shower', item: 'Shower Head & Hand Shower Flow Test' },
        { category: 'Shower', item: 'Glass Shower Enclosure & Magnetic Seals' },
        { category: 'Civil', item: 'Bathroom Waterproofing Inspection' },
        { category: 'Civil', item: 'Floor Drain Trap & Water Drain Slope Test' },
        { category: 'Civil', item: 'Floor & Wall Tiles Plumb, Level & Grouting' },
        { category: 'Accessories', item: 'Towel Rail, Paper Holder & Accessories Mounting' },
        { category: 'Ventilation', item: 'Exhaust Fan Air Extraction Test' },
        { category: 'Finishes', item: 'Perimeter Anti-Fungal Silicone Sealant' }
      ],
      bedroom: [
        { category: 'Paint', item: 'Wall Paint Finish & Uniformity' },
        { category: 'Paint', item: 'Ceiling Paint Finish & Smoothness' },
        { category: 'Joinery', item: 'Built-in Wardrobe Structure & Plumb' },
        { category: 'Joinery', item: 'Wardrobe Sliding Door Roller Mechanism' },
        { category: 'Joinery', item: 'Wardrobe Drawers & Internal Shelves Alignment' },
        { category: 'Joinery', item: 'Wardrobe Handles & Soft-Close Hinges' },
        { category: 'Windows', item: 'Window Handle, Lock & Double Glazing Glass' },
        { category: 'Doors', item: 'Bedroom Door Alignment, Hinges & Lock Test' },
        { category: 'Electrical', item: 'Lighting Switches & Power Outlets Test' },
        { category: 'Electrical', item: 'Headboard Power Outlets & USB Charger Test' },
        { category: 'Lighting', item: 'Ceiling Light Fixture & Dimmer Control' },
        { category: 'Flooring', item: 'Floor Tile Leveling, Grouting & Skirting Alignment' }
      ],
      balcony: [
        { category: 'Doors', item: 'Sliding Glass Door Rollers & Weather Seals' },
        { category: 'Civil', item: 'Balcony Railing Height & Anchor Bolts Fixation' },
        { category: 'Civil', item: 'Balcony Floor Slope & Waterproofing Trap' },
        { category: 'Electrical', item: 'External Weatherproof Light & Socket Test' }
      ],
      'electrical db': [
        { category: 'Electrical', item: 'Distribution Board Wire Dressing & Earth Continuity' },
        { category: 'Electrical', item: 'Circuit Breakers Labeling & Directory Index' },
        { category: 'Electrical', item: 'DB Door Lock & Safety Isolator Switch' }
      ]
    };
